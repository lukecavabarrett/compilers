...
TEST_PARSE_EXPRESSION("fun x -> x+1","ast::expression::fun{args : [ast::matcher::universal_matcher{name : 'x'}],  body : ast::expression::fun_app{f : ast::expression::fun_app{f : ast::expression::identifier{name : '+'},  x : ast::expression::identifier{name : 'x'}},  x : ast::expression::literal{value : ast::literal::integer{value : 1}}}}");
TEST_PARSE_EXPRESSION("(fun x -> x+1) + y","ast::expression::fun_app{f : ast::expression::fun_app{f : ast::expression::identifier{name : '+'},  x : ast::expression::fun{args : [ast::matcher::universal_matcher{name : 'x'}],  body : ast::expression::fun_app{f : ast::expression::fun_app{f : ast::expression::identifier{name : '+'},  x : ast::expression::identifier{name : 'x'}},  x : ast::expression::literal{value : ast::literal::integer{value : 1}}}}},  x : ast::expression::identifier{name : 'y'}}");
TEST_PARSE_EXPRESSION("(fun x -> fn_const x) y","ast::expression::fun_app{f : ast::expression::fun{args : [ast::matcher::universal_matcher{name : 'x'}],  body : ast::expression::fun_app{f : ast::expression::identifier{name : 'fn_const'},  x : ast::expression::identifier{name : 'x'}}},  x : ast::expression::identifier{name : 'y'}}");
TEST_PARSE_EXPRESSION("fun x -> fn_const x y","ast::expression::fun{args : [ast::matcher::universal_matcher{name : 'x'}],  body : ast::expression::fun_app{f : ast::expression::fun_app{f : ast::expression::identifier{name : 'fn_const'},  x : ast::expression::identifier{name : 'x'}},  x : ast::expression::identifier{name : 'y'}}}"
);
TEST_PARSE_EXPRESSION("fun x y (a,b) None -> fn_const x y","ast::expression::fun{args : [ast::matcher::universal_matcher{name : 'x'}, ast::matcher::universal_matcher{name : 'y'}, ast::matcher::tuple_matcher{args : [ast::matcher::universal_matcher{name : 'a'}, ast::matcher::universal_matcher{name : 'b'}]}, ast::matcher::constructor_matcher{cons : 'None',  arg : null}],  body : ast::expression::fun_app{f : ast::expression::fun_app{f : ast::expression::identifier{name : 'fn_const'},  x : ast::expression::identifier{name : 'x'}},  x : ast::expression::identifier{name : 'y'}}}"
);
TEST_PARSE_EXPRESSION("fun (Constr x) -> x + 2","ast::expression::fun{args : [ast::matcher::constructor_matcher{cons : 'Constr',  arg : ast::matcher::universal_matcher{name : 'x'}}],  body : ast::expression::fun_app{f : ast::expression::fun_app{f : ast::expression::identifier{name : '+'},  x : ast::expression::identifier{name : 'x'}},  x : ast::expression::literal{value : ast::literal::integer{value : 2}}}}")
TEST_PARSE_EXPRESSION("fun Constr (x) -> x + 2","ast::expression::fun{args : [ast::matcher::constructor_matcher{cons : 'Constr',  arg : ast::matcher::universal_matcher{name : 'x'}}],  body : ast::expression::fun_app{f : ast::expression::fun_app{f : ast::expression::identifier{name : '+'},  x : ast::expression::identifier{name : 'x'}},  x : ast::expression::literal{value : ast::literal::integer{value : 2}}}}")
