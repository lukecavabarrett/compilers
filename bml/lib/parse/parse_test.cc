...
TEST_PARSE_EXPRESSION("fun x -> x+1",
                      "ast::expression::fun{n_args : [ast::matcher::universal{name : 'x'}],  body : ast::expression::fun_app{f : ast::expression::fun_app{f : ast::expression::identifier{name : '__binary_op__PLUS__'},  x : ast::expression::identifier{name : 'x'}},  x : ast::expression::literal{value : ast::literal::integer{value : 1}}}}");
TEST_PARSE_EXPRESSION("(fun x -> x+1) + y",
                      "ast::expression::fun_app{f : ast::expression::fun_app{f : ast::expression::identifier{name : '__binary_op__PLUS__'},  x : ast::expression::fun{n_args : [ast::matcher::universal{name : 'x'}],  body : ast::expression::fun_app{f : ast::expression::fun_app{f : ast::expression::identifier{name : '__binary_op__PLUS__'},  x : ast::expression::identifier{name : 'x'}},  x : ast::expression::literal{value : ast::literal::integer{value : 1}}}}},  x : ast::expression::identifier{name : 'y'}}"
)
TEST_PARSE_EXPRESSION("(fun x -> fn_const x) y",
                      "ast::expression::fun_app{f : ast::expression::fun{n_args : [ast::matcher::universal{name : 'x'}],  body : ast::expression::fun_app{f : ast::expression::identifier{name : 'fn_const'},  x : ast::expression::identifier{name : 'x'}}},  x : ast::expression::identifier{name : 'y'}}");
TEST_PARSE_EXPRESSION("fun x -> fn_const x y",
                      "ast::expression::fun{n_args : [ast::matcher::universal{name : 'x'}],  body : ast::expression::fun_app{f : ast::expression::fun_app{f : ast::expression::identifier{name : 'fn_const'},  x : ast::expression::identifier{name : 'x'}},  x : ast::expression::identifier{name : 'y'}}}"
);
TEST_PARSE_EXPRESSION("fun x y (a,b) None -> fn_const x y",
                      "ast::expression::fun{n_args : [ast::matcher::universal{name : 'x'}, ast::matcher::universal{name : 'y'}, ast::matcher::tuple{n_args : [ast::matcher::universal{name : 'a'}, ast::matcher::universal{name : 'b'}]}, ast::matcher::constructor{cons : 'None',  arg : null}],  body : ast::expression::fun_app{f : ast::expression::fun_app{f : ast::expression::identifier{name : 'fn_const'},  x : ast::expression::identifier{name : 'x'}},  x : ast::expression::identifier{name : 'y'}}}"
);
TEST_PARSE_EXPRESSION("fun (Constr x) -> x + 2",
                      "ast::expression::fun{n_args : [ast::matcher::constructor{cons : 'Constr',  arg : ast::matcher::universal{name : 'x'}}],  body : ast::expression::fun_app{f : ast::expression::fun_app{f : ast::expression::identifier{name : '__binary_op__PLUS__'},  x : ast::expression::identifier{name : 'x'}},  x : ast::expression::literal{value : ast::literal::integer{value : 2}}}}"
)
TEST_PARSE_EXPRESSION("fun Constr (x) -> x + 2",
                      "ast::expression::fun{n_args : [ast::matcher::constructor{cons : 'Constr',  arg : ast::matcher::universal{name : 'x'}}],  body : ast::expression::fun_app{f : ast::expression::fun_app{f : ast::expression::identifier{name : '__binary_op__PLUS__'},  x : ast::expression::identifier{name : 'x'}},  x : ast::expression::literal{value : ast::literal::integer{value : 2}}}}"
)
TEST_PARSE_EXPRESSION("fun (Constr) x -> x + 2",
                      "ast::expression::fun{n_args : [ast::matcher::constructor{cons : 'Constr',  arg : null}, ast::matcher::universal{name : 'x'}],  body : ast::expression::fun_app{f : ast::expression::fun_app{f : ast::expression::identifier{name : '__binary_op__PLUS__'},  x : ast::expression::identifier{name : 'x'}},  x : ast::expression::literal{value : ast::literal::integer{value : 2}}}}"
)
...
TEST_PARSE_EXPRESSION("Error a , t ",
                      "ast::expression::tuple{n_args : [ast::expression::constructor{name : 'Error',  arg : ast::expression::identifier{name : 'a'}}, ast::expression::identifier{name : 't'}]}"
)
TEST_PARSE_MATCHER("Error _ , t ",
                   "ast::matcher::tuple{n_args : [ast::matcher::constructor{cons : 'Error',  arg : ast::matcher::ignore{}}, ast::matcher::universal{name : 't'}]}"
)
...
TEST_PARSE_DEFINITION("let rec f x = f x and x = f () ",
                      "ast::definition::t{rec : true,  defs : [ast::definition::def{name : ast::matcher::universal{name : 'f'},  e : ast::expression::fun{n_args : [ast::matcher::universal{name : 'x'}],  body : ast::expression::fun_app{f : ast::expression::identifier{name : 'f'},  x : ast::expression::identifier{name : 'x'}}}}, ast::definition::def{name : ast::matcher::universal{name : 'x'},  e : ast::expression::fun_app{f : ast::expression::identifier{name : 'f'},  x : ast::expression::literal{value : ast::literal::unit{}}}}]}"
);

TEST_PARSE_TYPE("int", "ast::type::expression::identifier{name : 'int'}");
TEST_PARSE_TYPE("int list",
                "ast::type::expression::constructor{x : ast::type::expression::identifier{name : 'int'},  f : ast::type::expression::identifier{name : 'list'}}");
TEST_PARSE_TYPE("int option",
                "ast::type::expression::constructor{x : ast::type::expression::identifier{name : 'int'},  f : ast::type::expression::identifier{name : 'option'}}"
);
TEST_PARSE_TYPE("int option list",
                "ast::type::expression::constructor{x : ast::type::expression::constructor{x : ast::type::expression::identifier{name : 'int'},  f : ast::type::expression::identifier{name : 'option'}},  f : ast::type::expression::identifier{name : 'list'}}"
);
TEST_PARSE_TYPE("int list option list",
                "ast::type::expression::constructor{x : ast::type::expression::constructor{x : ast::type::expression::constructor{x : ast::type::expression::identifier{name : 'int'},  f : ast::type::expression::identifier{name : 'list'}},  f : ast::type::expression::identifier{name : 'option'}},  f : ast::type::expression::identifier{name : 'list'}}"
);
TEST_PARSE_TYPE("(int,bool) result",
                "ast::type::expression::constructor{x : ast::type::expression::tuple{ts : [ast::type::expression::identifier{name : 'int'}, ast::type::expression::identifier{name : 'bool'}]},  f : ast::type::expression::identifier{name : 'result'}}"
);
TEST_PARSE_TYPE("(int * bool) list",
                "ast::type::expression::constructor{x : ast::type::expression::product{ts : [ast::type::expression::identifier{name : 'int'}, ast::type::expression::identifier{name : 'bool'}]},  f : ast::type::expression::identifier{name : 'list'}}"
);
TEST_PARSE_TYPE("int * bool list",
                "ast::type::expression::product{ts : [ast::type::expression::identifier{name : 'int'}, ast::type::expression::constructor{x : ast::type::expression::identifier{name : 'bool'},  f : ast::type::expression::identifier{name : 'list'}}]}"
);
TEST_PARSE_TYPE("int * (bool list)",
                "ast::type::expression::product{ts : [ast::type::expression::identifier{name : 'int'}, ast::type::expression::constructor{x : ast::type::expression::identifier{name : 'bool'},  f : ast::type::expression::identifier{name : 'list'}}]}"
);
...
TEST_PARSE_TYPE("'a list -> int",
                "ast::type::expression::function{from : ast::type::expression::constructor{x : ast::type::expression::identifier{name : ''a'},  f : ast::type::expression::identifier{name : 'list'}},  to : ast::type::expression::identifier{name : 'int'}}"
);
TEST_PARSE_TYPE("'a list -> ('a -> 'a -> bool) -> unit -> 'a list",
                "ast::type::expression::function{from : ast::type::expression::constructor{x : ast::type::expression::identifier{name : ''a'},  f : ast::type::expression::identifier{name : 'list'}},  to : ast::type::expression::function{from : ast::type::expression::function{from : ast::type::expression::identifier{name : ''a'},  to : ast::type::expression::function{from : ast::type::expression::identifier{name : ''a'},  to : ast::type::expression::identifier{name : 'bool'}}},  to : ast::type::expression::function{from : ast::type::expression::identifier{name : 'unit'},  to : ast::type::expression::constructor{x : ast::type::expression::identifier{name : ''a'},  f : ast::type::expression::identifier{name : 'list'}}}}}"
);

TEST_PARSE_TYPE_DECL("type block = int * t and t = unit -> block option",
                     "ast::type::definition::t{nonrec : false,  defs : [ast::type::definition::single_texpr{name : 'block',  type : ast::type::expression::product{ts : [ast::type::expression::identifier{name : 'int'}, ast::type::expression::identifier{name : 't'}]}}, ast::type::definition::single_texpr{name : 't',  type : ast::type::expression::function{from : ast::type::expression::identifier{name : 'unit'},  to : ast::type::expression::constructor{x : ast::type::expression::identifier{name : 'block'},  f : ast::type::expression::identifier{name : 'option'}}}}]}");
TEST_PARSE_TYPE_DECL("type 'a block = 'a * 'a t and 'a t = unit -> 'a block option",
                     "ast::type::definition::t{nonrec : false,  defs : [ast::type::definition::single_texpr{name : 'block',  type : ast::type::expression::product{ts : [ast::type::expression::identifier{name : ''a'}, ast::type::expression::constructor{x : ast::type::expression::identifier{name : ''a'},  f : ast::type::expression::identifier{name : 't'}}]}}, ast::type::definition::single_texpr{name : 't',  type : ast::type::expression::function{from : ast::type::expression::identifier{name : 'unit'},  to : ast::type::expression::constructor{x : ast::type::expression::constructor{x : ast::type::expression::identifier{name : ''a'},  f : ast::type::expression::identifier{name : 'block'}},  f : ast::type::expression::identifier{name : 'option'}}}}]}"
);
TEST_PARSE_TYPE_DECL("type 'a or_error = ('a,error) result ",
                     "ast::type::definition::t{nonrec : false,  defs : [ast::type::definition::single_texpr{name : 'or_error',  type : ast::type::expression::constructor{x : ast::type::expression::tuple{ts : [ast::type::expression::identifier{name : ''a'}, ast::type::expression::identifier{name : 'error'}]},  f : ast::type::expression::identifier{name : 'result'}}}]}"
);
TEST_PARSE_TYPE_DECL("type ('a,'b) tree = ('a,'b) result ",
                     "ast::type::definition::t{nonrec : false,  defs : [ast::type::definition::single_texpr{name : 'tree',  type : ast::type::expression::constructor{x : ast::type::expression::tuple{ts : [ast::type::expression::identifier{name : ''a'}, ast::type::expression::identifier{name : ''b'}]},  f : ast::type::expression::identifier{name : 'result'}}}]}"
);
TEST_PARSE_TYPE_DECL("type ('a,'b) result = | Okay of 'a | Error of 'b ",
                     "ast::type::definition::t{nonrec : false,  defs : [ast::type::definition::single_variant{name : 'result',  variants : [ast::type::definition::single_variant::constructor{name : 'Okay',  type : ast::type::expression::identifier{name : ''a'}}, ast::type::definition::single_variant::constructor{name : 'Error',  type : ast::type::expression::identifier{name : ''b'}}]}]}"
);
